...
document.addEventListener("DOMContentLoaded", () => {
  ...
  loadComponent(urlHeader, "header", () => {
    ...
    cityInput.addEventListener("input", () => {
      performSearch(eventsStore, cityInput, filterEventsByCity, ".meetUpEventDescription");
    ...
    searchEvent.addEventListener("keydown", (event) => {
      if (event.key === "Enter") {
        event.preventDefault();
        performSearch(eventsStore, searchEvent, filterEventsByTitel, ".meetUpEventDescription");
        searchEvent.value = "";
      }
    });
    ...
    searchLokation.addEventListener("keydown", (event) => {
      if (event.key === "Enter") {
        event.preventDefault();
        performSearch(eventsStore, searchLokation, filterEventsByCity, ".meetUpEventDescription");
    ...
    searchEventMedia.addEventListener("keydown", (event) => {
      if (event.key === "Enter") {
        event.preventDefault();
        performSearch(eventsStore, searchEventMedia, filterEventsByTitel, ".meetUpEventDescription");
